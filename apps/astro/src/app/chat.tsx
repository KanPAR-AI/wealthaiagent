...
const s = StyleSheet.create({
  ...
  headerSide: { width: 64 },
  headerAction: { color: t.palette.accent.interactive, fontSize: t.type.scale.sub, fontVariant: ['tabular-nums'] },
  ...
  headerSub: { color: t.palette.ink.muted, fontSize: t.type.scale.caption },
  ...
  userText: { color: t.palette.accent.interactiveInk, fontSize: t.type.scale.body, lineHeight: 22 },
  replyCard: {
  ...
  replyText: { color: t.palette.ink.primary, fontSize: t.type.scale.body, lineHeight: 24 },
  spinner: { marginTop: t.space(4) },
  hint: { color: t.palette.ink.muted, fontSize: t.type.scale.sub, lineHeight: 21, marginTop: t.space(2) },
  error: { color: t.palette.danger, fontSize: t.type.scale.sub, lineHeight: 20 },
  composer: {
    flexDirection: 'row',
    alignItems: 'flex-end',
    gap: t.space(2.5),
  ...
  sendGlyph: { color: t.palette.accent.interactiveInk, fontSize: 17, fontWeight: '700' },
});
