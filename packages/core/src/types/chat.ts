...
//
// Moved verbatim from apps' src/types/chat.ts EXCEPT the React-coupled
// types (ActionIconDefinition, ChatWindowProps) — those are UI concerns
// and live with each app's components.
